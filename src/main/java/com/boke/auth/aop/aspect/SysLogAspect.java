package com.boke.auth.aop.aspect;
...
import com.boke.auth.utils.HttpContextUtils;
import com.boke.auth.utils.IPUtils;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.boke.auth.aop.annotation.LogAnnotation)")
