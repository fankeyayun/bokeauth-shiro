...
import com.boke.auth.exception.code.ResponseCodeInterface;
 ...
 * TODO:类文件简单描述
 * @Author: as
 * @CreateDate: 2019/10/3 18:02
 * @UpdateUser: as
 * @UpdateDate: 2019/10/3 18:02
 * @Version: 0.0.1
 */
@Data
public class DataResult <T>{
     ...
     * 自定义 返回操作 data 可控
     * @Author:      as
     * @CreateDate:  2019/10/4 23:15
     * @UpdateUser:
     * @UpdateDate:  2019/10/4 23:15
     * @Version:     0.0.1
     * @param code
     * @param msg
     * @param data
